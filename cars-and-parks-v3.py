...
def find_closest_centroid(car_centroids, car_park_centroid, search_radius=100):
    """
    ...
    if success:
        ...
        for carPark in carParks:
            ...
            if M['m00'] != 0:
                ...
                closest_car_centroid = find_closest_centroid(car_centroids, car_park_centroid, search_radius=100)
